...
private final By LogoutLinkLocator = By.cssSelector("a.nav-link[href='/logout']");
    ...
    public void submitLoginForm (String registeredName, String password) {
       ...
       // WebDriverWait wait = new WebDriverWait(driver(), Duration.ofSeconds(10));
        ...
        WebElement nameButton = driverWait().until(ExpectedConditions.visibilityOfElementLocated(usernameLinkLocator));
        nameButton.sendKeys(registeredName);

        WebElement emailButton = driverWait().until(ExpectedConditions.visibilityOfElementLocated(passwordLinkLocator));
